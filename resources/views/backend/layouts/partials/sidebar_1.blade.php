                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li
                        ...
                        <ul class="collapse">
                            ...
                            <li class="{{ request()->routeIs('holidays.index') ? 'active' : '' }}"><a
                                    href="{{ route('holidays.index') }}">Holiday</a></li>
                        </ul>
                    </li>
                    <li
                        ...
                        <ul class="collapse">
                            ...
                            <li class="{{ request()->routeIs('checkout.monthly_overview') ? 'active' : '' }}"><a
                                    href="{{ route('checkout.monthly_overview') }}">Monthly Overview</a></li>
