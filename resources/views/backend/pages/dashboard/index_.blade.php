        ...
        <div class="sales-report-area mt-5 mb-5">
            <div class="row">
                @foreach ($weekDays as $dough)
                    <div class="col-md-4 mb-3" style="border: 5px solid rgb(204, 229, 245);">
                        <div class="single-report mb-xs-30">
                            <div class="s-report-inner pr--20 pt--30 mb-3">
                                <div class="icon"><i class="fa fa-cutlery"></i></div>
                                <div class="s-report-title d-flex justify-content-between">
                                    <h4 class="header-title mb-0">
                                        {{ $dough['dough_litter'] ?: '❌' }} L
                                    </h4>
                                    <p>{{ $dough['day'] }}</p>
                                </div>
                                <div class="d-flex justify-content-between pb-2">
                                    <h2>{{ $dough['dough_total_weight'] ?: '0' }} kg</h2>
                    ...
                    <div class="card-body">
                        <div class="row text-center">
                            ...
                            @for ($date = $start->copy(); $date->lte($end); $date->addDay())
                                <div class="col-md-2 border p-3 mb-3" style="min-height: 120px; border-radius:10px;">
                                ...
                                <table class="dbkit-table">
                                    ...
                                    <tr>
                                        <td class="mv-icon"><img
                                                src="{{ asset('admin/assets/images/icon/market-value/icon1.png') }}"
                                                alt="icon">
                                        </td>
                                        <td class="coin-name">Dashcoin</td>
                                        <td class="buy">30% <img
                                                src="{{ asset('admin/assets/images/icon/market-value/triangle-down.png') }}"
                                                alt="icon"></td>
                                        <td class="sell">20% <img
                                                src="{{ asset('admin/assets/images/icon/market-value/triangle-up.png') }}"
                                                alt="icon"></td>
                                        <td class="trends"><img
                                                src="{{ asset('admin/assets/images/icon/market-value/trends-up-icon.png') }}"
                                                alt="icon"></td>
                                    ...
                                    <tr>
                                        <td class="mv-icon">
                                            <div class="mv-icon"><img
                                                    src="{{ asset('admin/assets/images/icon/market-value/icon2.png') }}"
                                                    alt="icon"></div>
                                        </td>
                                        ...
                                        <td class="sell">20% <img
                                                ...
                                                alt="icon"></td>
                                        <td class="trends"><img
                                                src="{{ asset('admin/assets/images/icon/market-value/trends-down-icon.png') }}"
                                                alt="icon"></td>
                                        <td class="attachments">$ 56746,857</td>
                                        <td class="stats-chart">
                                    ...
                                    <tr>
                                        <td class="mv-icon">
                                            <div class="mv-icon"><img
                                                    src="{{ asset('admin/assets/images/icon/market-value/icon3.png') }}"
                                                    alt="icon"></div>
                                        </td>
                                    ...
                                    <tr>
                                        <td class="mv-icon">
                                            <div class="mv-icon"><img
                                                    src="{{ asset('admin/assets/images/icon/market-value/icon4.png') }}"
                                                    alt="icon"></div>
                                        </td>
                    ...
                    <div class="card-body">
                        ...
                        <div class="letest-news mt-5">
                            <div class="single-post mb-xs-40 mb-sm-40">
                                <div class="lts-thumb">
                                    <img src="{{ asset('admin/assets/images/blog/post-thumb1.jpg') }}"
                                        alt="post thumb">
                                </div>
                            ...
                            <div class="single-post">
                                <div class="lts-thumb">
                                    <img src="{{ asset('admin/assets/images/blog/post-thumb2.jpg') }}"
                                        alt="post thumb">
                                </div>
                                <div class="lts-content">
                                    <span>Admin Post</span>
